...
namespace Sanjok\Blog\Services\NepaliDate;
...
class NepaliDate
{
    ...
    public function getBsDate($date)
    {
        $carbon = \Carbon\Carbon::parse($date);
        $d = $this->convertAdToBs($carbon->year, $carbon->month, $carbon->day);
        $bs = $this->getDetails($d['year'], $d['month'], $d['day'], 'bs', 'np');
        return $this->getFormattedDate($bs, 'Y F d l');
    }
    /**
